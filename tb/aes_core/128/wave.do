...
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/mode
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/clk
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/reset
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/start
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/enc_dec
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/roundAmount
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/round
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/dec_key_schedule_round
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/enc_dec_reg
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/dec_key_gen
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/radix_width_sel
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/done
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/CURRENT_STATE
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/NEXT_STATE
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/start_prev
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/mode_reg
add wave -noupdate -group fsm /aes_core_gen_tb/dut/fsm/dec_key_schedule_round_next
